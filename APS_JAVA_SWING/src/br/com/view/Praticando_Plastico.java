...
public class Praticando_Plastico extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Praticando_Plastico frame = new Praticando_Plastico();
	...
	public Praticando_Plastico() {
		...
		labelImagemD.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoMetal.png"));
		labelImagemD.setBounds(0, 0, 150, 150);
		Painel_d.add(labelImagemD);

		JRadioButton Radio4 = new JRadioButton("D");
		Radio4.setFont(new Font("Showcard Gothic", Font.BOLD, 24));
		...
		labelImagemC.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoVidro.png"));
		labelImagemC.setBounds(0, 0, 150, 150);
		Painel_c.add(labelImagemC);

		JRadioButton Radio3 = new JRadioButton("C");
		Radio3.setForeground(new Color(0, 51, 0));
		Radio3.setFont(new Font("Showcard Gothic", Font.BOLD, 24));
		...
		labelImagemB.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoPrastico.png"));
		labelImagemB.setBounds(0, 0, 150, 150);
		Painel_b.add(labelImagemB);

		JRadioButton Radio2 = new JRadioButton("B");
		Radio2.setForeground(new Color(0, 51, 0));
		Radio2.setFont(new Font("Showcard Gothic", Font.BOLD, 24));
		...
		labelImagemA.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoPapel.png"));
		labelImagemA.setBounds(0, 0, 150, 150);
		Painel_a.add(labelImagemA);

		JRadioButton Radio1 = new JRadioButton("A");
		Radio1.setFont(new Font("Showcard Gothic", Font.BOLD, 24));
		Radio1.setForeground(new Color(0, 51, 0));
		...
		btnAvancar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (Radio2.isSelected()) {
					Imagem_Vidro imagem_Vidro = new Imagem_Vidro();
					imagem_Vidro.setVisible(true);
					dispose();
				}
			}
		});
		...
		JLabel lblQualDosLixos = new JLabel("Temos que jogar uma garrafa PET em qual lixo?");
		...
		lblQualDosLixos.setFont(new Font("Showcard Gothic", Font.BOLD, 22));
