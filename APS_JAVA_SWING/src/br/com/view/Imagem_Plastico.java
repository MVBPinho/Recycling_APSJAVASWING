...
public class Imagem_Plastico extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Imagem_Plastico frame = new Imagem_Plastico();
	...
	public Imagem_Plastico() {
		...
		btnAvancar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Praticando_Plastico praticando_Plastico = new Praticando_Plastico();
				praticando_Plastico.setVisible(true);
				dispose();
			}
		});
		...
		btnVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Praticando_Metal praticando_Metal = new Praticando_Metal();
				praticando_Metal.setVisible(true);
				dispose();
			}
		});
		...
		label.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\Plastico.png"));
