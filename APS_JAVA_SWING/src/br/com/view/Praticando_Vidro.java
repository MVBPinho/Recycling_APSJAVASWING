...
public class Praticando_Vidro extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Praticando_Vidro frame = new Praticando_Vidro();
	...
	public Praticando_Vidro() {
		...
		labelImagemD.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoPrastico.png"));
		...
		labelImagemB.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoMetal.png"));
			...
			public void actionPerformed(ActionEvent e) {
				if (Radio1.isSelected() || Radio2.isSelected() || Radio3.isSelected() || Radio4.isSelected()) {
					if (Radio3.isSelected()) {
						Imagem_Papel imagem_Papel = new Imagem_Papel();
						imagem_Papel.setVisible(true);
						dispose();
					}
				}
			}
		...
		JLabel lblQualDosLixos = new JLabel("Temos que jogar uma garrafa de vidro em qual lixo?");
