...
public class EsquadraoReciclagem extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EsquadraoReciclagem frame = new EsquadraoReciclagem();
	...
	public EsquadraoReciclagem() {
		...
		lblEsquadrao.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\Esquadrao.png"));
