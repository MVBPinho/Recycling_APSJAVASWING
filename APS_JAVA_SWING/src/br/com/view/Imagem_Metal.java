...
public class Imagem_Metal extends JFrame  {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Imagem_Metal frame = new Imagem_Metal();
	...
	public Imagem_Metal() {
		...
		label.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\Latinha.png"));
