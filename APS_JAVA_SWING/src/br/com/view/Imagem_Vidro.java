...
public class Imagem_Vidro extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Imagem_Vidro frame = new Imagem_Vidro();
	...
	public Imagem_Vidro() {
		...
		btnAvancar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Praticando_Vidro praticando_Vidro = new Praticando_Vidro();
				praticando_Vidro.setVisible(true);
				dispose();
			}
		});
		...
		label.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\Vidro.png"));
