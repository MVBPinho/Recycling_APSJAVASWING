...
public class Praticando_Papel extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Praticando_Papel frame = new Praticando_Papel();
	...
	public Praticando_Papel() {
		...
		labelImagemD.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoPapel.png"));
		...
		labelImagemA.setIcon(new ImageIcon("C:\\Users\\Marcos\\workspace\\ProjAPS\\ProjAPS\\Midias\\LixoVidro.png"));
		...
		btnVoltar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Imagem_Papel jornal = new Imagem_Papel();
				jornal.setVisible(true);
				dispose();
			}
		});
		contentPane.add(btnVoltar);

		JLabel lblQualDosLixos = new JLabel("Temos que jogar papel em qual lixo?");
